...
DROP TABLE IF EXISTS "aluno_grade" CASCADE;
DROP TABLE IF EXISTS "curso" CASCADE;
DROP TABLE IF EXISTS "politecnico" CASCADE;
...
CREATE TABLE "politecnico" (
  "idPolitecnico" SERIAL PRIMARY KEY,
  "nome" VARCHAR(100) NOT NULL,
  "sitio" VARCHAR(100) DEFAULT NULL
);

--
-- Inserção de dados na tabela "politecnico"
--
...
CREATE TABLE "curso" (
  ...
  "idPolitecnico" INTEGER NOT NULL,
  "nome" VARCHAR(50) NOT NULL,
  "tipo" VARCHAR(25) NOT NULL,
  "autorizacao" VARCHAR(100) DEFAULT NULL,
  CONSTRAINT "fk_curso_politecnico" FOREIGN KEY ("idPolitecnico") REFERENCES "politecnico" ("idPolitecnico")
);
...
CREATE TABLE "disciplina" (
  ...
  "nome" VARCHAR(100) NOT NULL,
  "ch" INTEGER DEFAULT NULL,
  "ects" REAL DEFAULT NULL,
...
(391, 'Contabilidade Analítica I', 0, 5, NULL, NULL),
...
(494, 'Noções de Gestão (opcional)', 0, 3, NULL, NULL),
...
CREATE TABLE "aluno_grade" (
  ...
  "idAluno" INTEGER DEFAULT NULL,
  "idGrade" INTEGER DEFAULT NULL,
  "integralizado" BOOLEAN NOT NULL,
  "anoEntrada" INTEGER NOT NULL,
  CONSTRAINT "fk_aluno_grade_aluno" FOREIGN KEY ("idAluno") REFERENCES "aluno" ("idAluno"),
  CONSTRAINT "fk_aluno_grade_grade" FOREIGN KEY ("idGrade") REFERENCES "grade" ("idGrade")
);

--
-- Inserção de dados na tabela "aluno_grade"
--
...
CREATE TABLE "grade_disciplina" (
  "idGrade" INTEGER NOT NULL DEFAULT 0,
  "idDisciplina" INTEGER NOT NULL DEFAULT 0,
  "tipo" VARCHAR(25) NOT NULL,
  "periodo" INTEGER NOT NULL,
  PRIMARY KEY ("idGrade", "idDisciplina"),
  CONSTRAINT "fk_grade_disciplina_grade" FOREIGN KEY ("idGrade") REFERENCES "grade" ("idGrade"),
  CONSTRAINT "fk_grade_disciplina_disciplina" FOREIGN KEY ("idDisciplina") REFERENCES "disciplina" ("idDisciplina")
);

--
-- Inserção de dados na tabela "grade_disciplina"
--
...
CREATE TABLE "historico" (
  ...
  "data" DATE NOT NULL,
  "nota" REAL NOT NULL,
  "matricula" INTEGER DEFAULT NULL,
  "idDisciplina" INTEGER DEFAULT NULL,
  "status" VARCHAR(25) NOT NULL,
  CONSTRAINT "fk_historico_aluno_grade" FOREIGN KEY ("matricula") REFERENCES "aluno_grade" ("matricula"),
...
CREATE TABLE "pre_requisito" (
  ...
  "idDisciplinaAnt" INTEGER DEFAULT NULL,
  "idDisciplinaPost" INTEGER DEFAULT NULL,
