      ...
      <div className="h-screen flex flex-col items-center bg-gray-900 p-4 sm:p-6 md:p-8">
        <form className="w-[70%] h-[95%] bg-[#202024] flex flex-col">
          ...
          <div className="flex justify-end mt-2 mb-4 mr-2">
            <button type="button" className="px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">submit</button>
          </div>
        </form>
      </div>
    );
